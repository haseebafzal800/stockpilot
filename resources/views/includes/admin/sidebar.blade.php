        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item ">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{@url('/admin/settings/home')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Home</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{@url('/admin/settings/about-us')}}" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>About US</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="{{@url('/admin/settings/services')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Services</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{@url('/admin/settings/portfolio')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Portfolio</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{@url('/admin/settings/support')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Support</p>
                </a>
              </li>
