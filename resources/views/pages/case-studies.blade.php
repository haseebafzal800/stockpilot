                        ...
                        <div class="col-12 col-md-5 col-lg-5">
                            <div class="about-us-image mb-5">
                                <div class="about-us-image-section">
                                    <img src="images/case-study.png" alt="image" class="img-fluid">
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-md-7 col-lg-7 px-lg-5">
                            <div class="about-us-content text-center text-md-start case-study-heading">
                                <strong class="case-study-tab mb-3"><span class="case-1">1/ </span> CASE STUDY</strong>
                                <h2 class="mb-md-4">Case Study Name</h2>
                    ...
                    <div class="row align-items-center text-center text-md-start">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="case-study-business-text">
                                <p>Client-centered, digital marketing campaigns built around your goals and managed closely by friendly experts who keep you in the loop. Satisfy the bottom line and give your whole team peace of mind as we charge towards your targets together.</p>
                            </div>
                        </div> 
                    </div> 
                </div>
                                            ...
                                            <div class="d-flex justify-content-between align-items-center flex-wrap pb-4">
                                               <a class="btn case-link mb-2 mb-md-0" href="#">WEB</a>
                                                <div class="case-title">
                                                    <p class="mb-0"><span class="me-3">Lorem 12</span><span>8 min read</span></p>
                                                </div>
                                            </div>
                                            <h3 class="  mb-3">8 Easy Ways to Cut Down on Software Development Cost.</h3>
